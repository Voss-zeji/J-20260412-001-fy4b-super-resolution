...
"""
新论文方法批量训练脚本
训练 30_dual_branch_pftsr 和 32_physics_pftsr，200 epoch，CH07
"""
...
METHODS = {
    '30_method_dual_branch_pftsr': METHODS_DIR / '30_method_dual_branch_pftsr' / 'main.py',
    '32_method_physics_pftsr': METHODS_DIR / '32_method_physics_pftsr' / 'main.py',
}
